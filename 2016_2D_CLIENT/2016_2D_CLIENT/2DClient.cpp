...
#include "gpdumb1.h"
#include "..\..\2016Server\2016Server\protocol.h"
...
#define WINDOW_WIDTH    745   // size of window
...
int Game_Main(void *parms)
{
	...
	for (int i = 0; i < 11; ++i)
	{
		for (int j = 0; j < 11; ++j)
		{
			...
			if ((tile_x % 8 == 0) && (tile_y % 8 == 0))
				Draw_Bitmap32(&indicateImage, TILE_WIDTH * i - 5, TILE_WIDTH * j - 5);
		}
	}
	...
	// draw the skelaton
	Draw_BOB32(&player);
	for (int i = 0; i < MAX_USER; ++i) Draw_BOB32(&npc[i]);
